...
Model Optimization
Ongoing work to reduce latency caused by GPT-4 response times.
Prompt Engineering
Improving prompt structure so the AI can better understand and operate within 3D coordinate space.
...
모델 최적화: 현재 GPT-4 기반의 응답 대기 시간(Latency)을 줄이기 위한 최적화 작업이 진행 중입니다.

프롬프트 엔지니어링: AI가 3D 좌표 공간을 더 정확히 이해할 수 있도록 프롬프트 구조를 고도화하고 있습니다.
